...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Currency List</b>
            <a href="<?php echo base_url('main/currency'); ?>" class="btn col-sm-2 " id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span> New Currency</b></a>
        </h3>
    </div>
...
//            exit;
            foreach ($value as $currency) {
                ...
                <tr>
                    ...
                    <td><?php echo $currency['short_form'] ?></td>
                    <td><?php echo $currency['symbol_text'] ?></td>
                    <td><?php echo $currency['keyword_value'] ?></td>
                    <td><?php echo $currency['fractional_unit'] ?></td>
                    <td><a href="<?php echo base_url('main/currency') . '/' . $currency['currency_id'] ?>">Edit</a></td>
                </tr>
    <?php
}
?> 
