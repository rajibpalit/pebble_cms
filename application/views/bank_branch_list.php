...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Bank Branch List</b>
            <a href="<?php echo base_url('main/bank_branch'); ?>" class="btn col-sm-2 " style="background-color: #85C51F; margin-right: 10px; padding: 4px; color: white; font-size: 20px; float: right"><b><span class="glyphicon glyphicon-plus"></span> New Branch</b></a>
        </h3>
    </div>
            ...
            foreach ($value as $key) {
                ...
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td><a href="<?php echo base_url('main/bank_branch') . '/' . $key['id'] ?>">Edit</a></td>
                </tr>
                <?php
            }
            ?> 
