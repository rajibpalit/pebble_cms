...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Product List</b>
            <a href="<?php echo base_url('main/add_product'); ?>" class="btn col-sm-2 " id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span> New Product</b></a>
        </h3>
    </div>
    ...
    <div id="search" class="search_div"> <!-- start search div -->
        <form class="form-inline" method="POST" action="<?php echo base_url('main/client') ?>"> <!--start search form -->
            <div class="form-group">
                <label for="keyword_for">Product Name</label>
                <input type="text" class="form-control" name="product_name" id="keyword_for" placeholder="Product Name">
            </div>
            <div class="form-group">
        ...
        <table class="table table-striped">
            ...
            foreach ($value as $key) {
                ...
                <tr>
                    ...
                    <td><?php echo $key['default_rate'] ?></td>
                    <td><a href="<?php echo base_url('main/add_product') . '/' . $key['id'] ?>">Edit</a></td>
                </tr>
                <?php
            }
            ?> 
