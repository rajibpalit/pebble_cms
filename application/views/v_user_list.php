...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>User List</b>
            <a href="<?php echo base_url('main/user'); ?>" class="btn col-sm-2 " id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span>Add User</b></a>
        ...
        <table class="table table-striped">
            ...
            foreach ($value as $user) {
                ...
                echo "Inactive";
                    ...
                    <td><a href="<?php echo base_url('main/user') . '/' . $user['user_id'] ?>">Edit</a></td>
                </tr>
    <?php
}
?> 
