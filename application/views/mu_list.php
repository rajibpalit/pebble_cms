...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>MU List</b>
            <a href="<?php echo base_url('main/add_mu_conversion'); ?>" class="btn col-sm-2 " id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span> New MU</b></a>
    ...
    <div id="search" class="search_div"> <!-- start search div -->
        <form class="form-inline" method="POST" action="<?php echo base_url('main/mu_list') ?>"> <!--start search form -->
    ...
    <div>
        <table class="table table-striped">
            ...
            <?php
            $count = 0;
            foreach ($value_from as $key) {
                ?>
                <tr>
                    <td><?php echo $key['keyword_value'] ?></td>
                    <td><?php echo $value_to[$count]['keyword_value'] ?></td>
                    <td><?php echo $key['quantity'] ?></td>
                    <td><a href="<?php echo base_url('main/add_mu_conversion') . '/' . $key['id'] ?>">Edit</a></td>
                </tr>
                <?php
                $count++;
            }
