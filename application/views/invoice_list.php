...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Invoice List</b>
            <a href="<?php echo base_url('home/add_invoice'); ?>" class="btn col-sm-2 " id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span>New Invoice</b></a>
        </h3>
    </div>
        ...
        <table class="table table-striped">
            ...
            foreach ($invoice as $key) {
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url('home/add_invoice') . '/' . $key['inv_id'] ?>">Edit</a></td>
                </tr>
                <?php
            }
            ?> 
