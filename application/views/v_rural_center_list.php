...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Rural Center List</b>
            <a href="<?php echo base_url('main/rural_center'); ?>" class="btn col-sm-2" id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span>New Center</b></a>
        ...
        <table class="table table-striped">
            ...
            foreach ($value as $center) {
                ...
                <tr>
                    ...
                    <td><?php echo $center['artisan_capacity'] ?></td>
                    <td><?php echo $center['hour_capacity'] ?></td>
                    <td><?php echo $center['hourly_rate'] ?></td>
                    <td><?php if( $center['status']==1){echo "Active";}  else {echo "Inactive";} ?></td>
                    <td><a href="<?php echo base_url('main/rural_center').'/'.$center['id']?>">Edit</a></td>
                </tr>
                <?php
            }
            ?> 
