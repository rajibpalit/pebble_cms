...
<div class="container" style="background-color: white;min-height: 600px">
    ...
    <div class="title" style="border-bottom: 5px solid #E5E5E5;">
        <h3><b>
                <?php echo (isset($rawmat_pur_edit)) ? 'Update Material Purchase' : 'New Raw Material Purchase' ?></b></h3>
    </div> 
    ...
    <div style="margin-top: 5%; margin-left: 2%;">
        <form class="form-inline" id="invoice_info" role="form" method="POST" action="<?php echo base_url('rawmat_rec/rawmat_from') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="challan_no" value="<?php echo (isset($rawmat_pur_edit)) ? $rawmat_pur_edit[0]['challan_number'] : '' ?>" name="challan_no" >
            </div>
            <div class="form-group">
                <label for="delivery_date">Challan Date.</label>
                <input type="text" class="form-control" id="challan_date" value="<?php echo (isset($rawmat_pur_edit)) ? $rawmat_pur_edit[0]['challan_date'] : '' ?>" name="challan_date" >
            </div>

            <div class="form-group">
                <label for="remarks">Remarks</label>
                <textarea class="form-control" id="remarks" name="remarks" placeholder="Remarks"><?php echo $remarks ?></textarea>
            </div>                           
        ...
        <table class="table table-bordered" id="bank_table">
            ...
            <?php
                ...
                foreach ($rawmat_pur_product as $product) {
                    ...
                    ?>
                    <tr>                
                        <td><input type="text" name="" class="form-control " value="<?php echo $product['material_code']; ?>" id="name_0" onclick="autocom(this)" onblur="compute_field(this)"/></td>
                        ...
                        <td><input type="text" name="" class="form-control" value="<?php echo $product['order_qty']; ?>"  id="orderq_0" /></td>                  
                        <td><input type="text" name="" class="form-control"   id="recived_0" /></td>
                        <td><input type="text" name="" class="form-control"  id="recive_0" /></td>
                        <td><input type="text" name="" class="form-control"  id="batch_0" /></td>
                        <td><input type="text" name="" class="form-control "   id="expired_<?php echo $i?>" onclick="get_date(this)"/></td>                       
        ...
        <div class="sub_cancel">
            <input type="button" id="<?php echo (isset($rawmat_pur_edit)) ? 'update' : 'submit'; ?>" value="<?php echo (isset($rawmat_pur_edit)) ? 'Update' : 'Submit'; ?>" class="btn btn-primary"/>
