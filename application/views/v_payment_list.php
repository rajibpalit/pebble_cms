...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Payment Mode List</b>
            <a href="<?php echo base_url('main/payment_mode'); ?>" class="btn col-sm-2" id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span>New Payment</b></a>
        ...
        <table class="table table-striped">
            ...
            foreach ($value as $payment) {
                ...
                <tr>
                    ...
                    <td><?php echo $payment['payment_particular'] ?></td>
                    <td><?php if( $payment['status']==1){echo "Active";}  else {echo "Inactive";} ?></td>
                    <td><a href="<?php echo base_url('main/payment_mode').'/'.$payment['id']?>">Edit</a></td>
                </tr>
                <?php
            }
            ?> 
