...
<div class="container list_content">
    <div class="title list_title">
        <h3><b>Client List</b>
            <a href="<?php echo base_url('main/client'); ?>" class="btn col-sm-2 " id="add_new_btn" style=""><b><span class="glyphicon glyphicon-plus"></span> New Client</b></a>
        </h3>
    </div>
...
//                print_r($value);exit;
                ...
                <tr>
                    ...
                    <td><?php echo $key['short_form'] ?></td>
                    <td><?php echo $key['invoice_prefix'] ?></td>
                    <td><?php
                        if ($key['status'] == 1) {
                            echo "Active";
                        } else {
                        ...
                        ?></td>
                    <td><a href="<?php echo base_url('main/client') . '/' . $key['client_id'] ?>">Edit</a></td>
                </tr>
                <?php
            }
            ?> 
