        ...
        <form class="form-horizontal" id="keyword_insert" role="form" method="post" action="<?php echo base_url('main/add_currency') ?>">
            ...
            <div style="float: left; width: 100%; text-align: center">
                <table class="table table-bordered" id="task">
                    ...
                    <tr>
                        <td>
                            <input type="text" name="" id="example" class="form-control example" onclick="autocom()">
                        </td>
                        <td>
            ...
            <div style="float: left; width: 100%;">
                <table class="table table-bordered" style=""  id="item">
                    <tr class="list_header">
                        <th>Item</th>
                        <th>Description</th>
                        <th>Unit Cost</th>
            ...
            <div style="float: left; width: 100%">
                <div class="col-lg-7">
                    ...
                    <select id="add_row" style="float: left; width: 21px; height: 37px; background-color: white; border-radius:0 5px 5px 0;" class="" id="" name="">                      
